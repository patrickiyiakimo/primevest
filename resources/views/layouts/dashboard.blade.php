...
<head>
    ...
    <style>
        :root{
            ...
            --acc:#18d893; --acc2:#00e3a5; --gold:#f0b90b; --red:#ef4444; --side:240px;
            --rad:16px;
        }
        *{box-sizing:border-box}
        ...
        .plan:hover{transform:translateY(-4px);border-color:rgba(24,216,147,.4)}
...
<aside class="side" id="pvSide">
    <div class="side-logo">
        <a href="{{ url('/') }}" style="display:flex;align-items:center;gap:10px">
            ...
            <span style="font-weight:800;font-size:1.15rem">Prime<span style="color:var(--acc)">Vest</span></span>
        </a>
    </div>
    <nav class="side-nav">
        ...
        <a href="{{ route('trading') }}#copy-trading" class="side-item">
