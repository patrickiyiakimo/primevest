<nav x-data="{ mobileMenuOpen: false }" x-init="$nextTick(() => { mobileMenuOpen = false })" class="fixed top-0 left-0 right-0 z-50 bg-black backdrop-blur-md border-b border-white/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <!-- Desktop Auth Buttons (Moved to the right) -->
    ...
    <div class="hidden md:block bg-white border-b border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center space-x-8 py-3">
                @guest
                    <a href="/trading" class="text-gray-700 hover:text-red-600 transition-all duration-300 text-sm font-medium">Trading</a>
                    <a href="/company" class="text-gray-700 hover:text-red-600 transition-all duration-300 text-sm font-medium">Company</a>
                    <a href="/education" class="text-gray-700 hover:text-red-600 transition-all duration-300 text-sm font-medium">Education</a>
                    <a href="/contact" class="text-gray-700 hover:text-red-600 transition-all duration-300 text-sm font-medium">Contact</a>
                @endguest
            </div>
        </div>
    </div>
