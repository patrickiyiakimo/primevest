...
<div class="relative min-h-screen  overflow-hidden">
    ...
    <!-- Hero Content -->
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-3 py-5 lg:py-20">
        <div class="">
            <!-- Main Heading -->
            <h1 class="text-4xl sm:text-5xl lg:text-4xl xl:text-4xl font-bold text-white mb-6 leading-tight">
                COPY TRADING ON
