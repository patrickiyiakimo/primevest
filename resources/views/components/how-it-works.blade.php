    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            <div class="inline-block mb-4">
                <span class="bg-green-100 text-green-700 text-sm font-semibold px-4 py-2 rounded-full">Simple Process</span>
            </div>
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                Trade with <span class="text-green-600">Confidence</span>
            </h2>
        ...
        <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0">
                ...
                <div class="relative text-center px-6 md:px-8">
                    ...
                    <!-- Step Number -->
                    <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-600 to-green-700 text-white text-2xl font-bold rounded-full mb-6 shadow-lg">
                        1
                    </div>
        ...
        <div class="text-center mt-12">
            <a href="{{ route('register') }}" class="inline-flex items-center space-x-2 px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-full transition-all duration-300 shadow-md">
