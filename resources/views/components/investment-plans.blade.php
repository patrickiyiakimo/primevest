...
<div class="bg-gray-50 py-20 lg:py-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                ...
                <div class="p-6">
                    ...
                    <div class="text-center mb-4">
                        <div class="inline-block px-4 py-1 bg-red-100 rounded-full mb-3">
                            <span class="text-red-700 text-xs font-semibold uppercase tracking-wider">Minimum Funding</span>
                        </div>
            ...
            <button class="w-full py-3 bg-white border-2 border-red-600 text-red-600 font-semibold rounded-xl hover:bg-red-600 hover:text-white transition-all duration-300">
                            Open an Account
                        </button>
                    </a>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden relative group">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('register') }}">
                        <button class="w-full py-3 bg-red-600 text-white font-semibold rounded-xl hover:bg-red-700 transition-all duration-300 shadow-md">
                            Open an Account
                        </button>
                    </a>
                </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                <div class="p-6">
                    ...
                    <a href="{{ route('register') }}">
                        <button class="w-full py-3 bg-white border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 hover:border-red-500 hover:text-red-600 transition-all duration-300">
                            Open an Account
                        </button>
                    </a>
                </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group border border-yellow-200">
                ...
                <div class="p-6">
                    <div class="text-center mb-4">
                        <div class="inline-block px-4 py-1 bg-yellow-100 rounded-full mb-3">
                            <span class="text-yellow-700 text-xs font-semibold uppercase tracking-wider">Minimum Funding</span>
                        </div>
                        <div class="text-4xl font-bold text-gray-900">$50,000</div>
                    </div>
                    
                    <div class="text-center mb-4 pb-4 border-b border-yellow-200">
                    ...
                    <a href="{{ route('register') }}">
                        <button class="w-full py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-semibold rounded-xl hover:from-yellow-600 hover:to-yellow-700 transition-all duration-300 shadow-md">
                            Open an Account
                        </button>
                    </a>
                </div>
        ...
        <!-- Trust Badges -->
        <div class="mt-12 pt-8 border-t border-gray-200 flex flex-wrap justify-center gap-8">
