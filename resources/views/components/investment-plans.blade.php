        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden group">
                <div class="p-6">
                    ...
                    <div class="text-center mb-4">
                        <div class="inline-block px-4 py-1 bg-green-100 rounded-full mb-3">
                            <span class="text-green-700 text-xs font-semibold uppercase tracking-wider">Minimum Funding</span>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden relative group">
                ...
                <div class="p-6">
                    ...
                    <a href="{{ route('register') }}">
                        <button class="w-full py-3 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-all duration-300 shadow-md">
                            Open an Account
                        </button>
                    </a>
                </div>
