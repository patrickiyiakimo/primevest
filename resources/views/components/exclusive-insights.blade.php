    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Daily Market Analysis</h3>
                    <ul class="space-y-3">
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Daily market analysis directly to your inbox</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">The latest financial news and forecasts</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Weekly webinars with industry experts</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Premium Trader Tools</h3>
                    <ul class="space-y-3">
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Multi-platform customized solutions</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Covering a range of trading needs & styles</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Available in multiple languages worldwide</span>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
                ...
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-800 mb-3">Ultimate Insurance</h3>
                    <ul class="space-y-3">
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Client funds market leading insurance</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Insurance coverage up to $1,000,000</span>
                        </li>
                        <li class="flex items-start text-gray-600">
                            <svg class="w-5 h-5 text-red-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                            </svg>
                            <span class="text-sm">Your funds' security is our top priority</span>
                        </li>
                    </ul>
                </div>
            </div>
