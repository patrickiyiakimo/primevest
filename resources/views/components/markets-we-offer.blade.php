    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-bold text-gray-800">Forex</h3>
                    </div>
            ...
            <div class="border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-bold text-gray-800">Shares</h3>
                    </div>
                    <div class="border-t border-gray-200 mb-4"></div>
                    <p class="text-gray-500 leading-relaxed">
            ...
            <div class="border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-bold text-gray-800">Energies</h3>
                    </div>
                    <div class="border-t border-gray-200 mb-4"></div>
                    <p class="text-gray-500 leading-relaxed">
            ...
            <div class="border border-gray-200">
                <div class="p-5">
                    <div class="flex items-center gap-3 mb-4">
                        ...
                        <h3 class="text-xl font-bold text-gray-800">Indices</h3>
                    </div>
                    <div class="border-t border-gray-200 mb-4"></div>
                    <p class="text-gray-500 leading-relaxed">
        ...
        <div class="mt-16">
            <div class="text-center mb-10">
                ...
                <p class="text-gray-500">Trade the most popular digital assets with competitive spreads</p>
            </div>
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-3">
                                <div class="w-12 h-12 bg-red-600 flex items-center justify-center">
                                    <img src="{{ asset('images/btc.png') }}" alt="Bitcoin" class="w-7 h-7">
                                </div>
                                <div>
                            ...
                            <span class="text-green-600 text-sm font-semibold">+2.34%</span>
                        </div>
                        <div class="border-t border-gray-200 mb-4"></div>
                        ...
                        <div class="mt-4 pt-2">
                            <a href="/trading" class="text-red-600 hover:text-red-700 text-sm font-semibold flex items-center">
                                Trade Bitcoin
                ...
                <div class="border border-gray-200">
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-green-600 text-sm font-semibold">+1.56%</span>
                        </div>
                        <div class="border-t border-gray-200 mb-4"></div>
                        <p class="text-gray-500 text-sm leading-relaxed">
                ...
                <div class="border border-gray-200">
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-red-600 text-sm font-semibold">-0.45%</span>
                        </div>
                        <div class="border-t border-gray-200 mb-4"></div>
                        <p class="text-gray-500 text-sm leading-relaxed">
                            Bitcoin Cash is a cryptocurrency that is a fork of Bitcoin. Bitcoin Cash is a spin-off or altcoin that was created in 2017. In November 2018, Bitcoin Cash split further into two cryptocurrencies.
                        </p>
                        <div class="mt-4 pt-2">
                            <a href="/trading" class="text-red-600 hover:text-red-700 text-sm font-semibold flex items-center">
                                Trade Bitcoin Cash
                ...
                <div class="border border-gray-200">
                    <div class="p-5">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <span class="text-green-600 text-sm font-semibold">+5.67%</span>
                        </div>
                        <div class="border-t border-gray-200 mb-4"></div>
                        <p class="text-gray-500 text-sm leading-relaxed">
