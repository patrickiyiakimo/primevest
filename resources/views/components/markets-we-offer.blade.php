    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div class="bg-navy-800 rounded-2xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-navy-700 hover:border-green-500/50 group">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Forex</h3>
            ...
            <div class="bg-navy-800 rounded-2xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-navy-700 hover:border-green-500/50 group">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Shares</h3>
                <p class="text-gray-300 leading-relaxed">
            ...
            <div class="bg-navy-800 rounded-2xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-navy-700 hover:border-green-500/50 group">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Energies</h3>
                <p class="text-gray-300 leading-relaxed">
            ...
            <div class="bg-navy-800 rounded-2xl p-6 hover:transform hover:-translate-y-2 transition-all duration-300 border border-navy-700 hover:border-green-500/50 group">
                ...
                <h3 class="text-xl font-bold text-white mb-3">Indices</h3>
                <p class="text-gray-300 leading-relaxed">
                ...
                <div class="bg-navy-800 rounded-2xl overflow-hidden hover:transform hover:-translate-y-2 transition-all duration-300 border border-navy-700 hover:border-green-500/50 group">
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-12 h-12 bg-orange-500/20 rounded-full flex items-center justify-center">
                                    <span class="text-orange-400 font-bold text-lg">BTC</span>
                                </div>
                                <div>
                                    <h4 class="text-white font-bold text-lg">Bitcoin</h4>
                        ...
                        <div class="mt-4 pt-4 border-t border-navy-700">
                            <a href="/trading" class="text-green-400 hover:text-green-300 text-sm font-semibold flex items-center group">
                                Trade Bitcoin
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center">
                                    <span class="text-purple-400 font-bold text-lg">ETH</span>
                                </div>
                                <div>
                                    <h4 class="text-white font-bold text-lg">Ethereum</h4>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                <div class="w-12 h-12 bg-yellow-500/20 rounded-full flex items-center justify-center">
                                    <span class="text-yellow-400 font-bold text-lg">DOGE</span>
                                </div>
                                <div>
                                    <h4 class="text-white font-bold text-lg">Dogecoin</h4>
        ...
        <div class="text-center mt-12">
            <a href="/register" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white font-semibold rounded-lg duration-500 shadow-lg">
                Start Trading Now
