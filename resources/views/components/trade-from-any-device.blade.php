...
<!-- Black Crypto Deposit Section - Completes the image -->
                <div class="max-w-7xl mx-auto bg-black p-6 mt-[-2px]">
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <a href="/register" class="inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold duration-300 shadow-md hover:shadow-lg whitespace-nowrap">
                            Get Started
