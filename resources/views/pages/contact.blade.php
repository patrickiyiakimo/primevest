...
<div class="relative overflow-hidden min-h-[400px] flex items-center">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-green-600/20 via-transparent to-transparent z-10"></div>
    </div>
    ...
    <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="max-w-3xl">
            <div class="inline-flex items-center px-3 py-1 rounded-full bg-green-500/20 border border-green-500/30 mb-6">
                ...
                <span class="text-green-400 text-xs font-semibold uppercase tracking-wider">Get in Touch</span>
            </div>
            <h1 class="text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 leading-tight">
                HOW CAN WE <span class="text-green-400">HELP?</span>
            </h1>
                ...
                <div class="bg-gray-50 rounded-2xl p-8 transition-all duration-300 hover:shadow-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:enquiries@primevest.com" class="text-green-600 hover:text-green-700 transition-colors duration-300 break-all">
                ...
                <div class="bg-gray-50 rounded-2xl p-8 transition-all duration-300 hover:shadow-lg">
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            ...
                            <a href="mailto:support@primevest.com" class="text-green-600 hover:text-green-700 transition-colors duration-300 break-all">
                                support@primevest.com
                            </a>
                        </div>
                    </div>
