    ...
    <div class="relative z-20 px-4 sm:px-6 lg:px-8 py-20">
        <div class="">
            ...
            <h1 class="text-4xl lg:text-4xl font-bold text-white mb-4 leading-tight">
                NO COMMISSIONS. <span class="text-green-400">NO FEES.</span>
            </h1>
...
<div class="bg-navy-900 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <div class="w-20 h-1 bg-green-500 mx-auto mt-6"></div>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            
            <!-- Licensed & Regulated -->
            <div class="bg-navy-800 rounded-2xl p-6 text-center transition-all duration-300 hover:transform hover:-translate-y-1">
...
<div class="bg-navy-900 py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl lg:text-5xl font-bold text-green-400 mb-6">
                GLOBAL MARKETS
            </h2>
            <p class="text-xl text-gray-300">
