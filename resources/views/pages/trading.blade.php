...
<div class="relative overflow-hidden">
    ...
    <div class="absolute inset-0 z-0">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-gray-900/95 via-gray-900/90 to-gray-900/85"></div>
    </div>
...
<div class="bg-white py-20 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-green-100 mb-6">
                    <span class="text-green-700 text-xs font-semibold uppercase tracking-wider">Instant Access</span>
                </div>
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                    INSTANT ACCESS TO <span class="text-green-600">GLOBAL MARKETS</span>
                </h2>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <div class="inline-flex items-center px-3 py-1 rounded-full bg-green-100 mb-4">
                <span class="text-green-700 text-xs font-semibold uppercase tracking-wider">Why Choose Us</span>
            </div>
            <h2 class="text-3xl lg:text-4xl font-bold text-gray-900">
                THE BEST IN THE <span class="text-green-600">BUSINESS</span>
            </h2>
        </div>
...
<div class="bg-white py-20 lg:py-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
                <div class="inline-flex items-center px-3 py-1 rounded-full bg-green-100 mb-6">
                    <span class="text-green-700 text-xs font-semibold uppercase tracking-wider">Understanding Swaps</span>
                </div>
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                    WHAT ARE <span class="text-green-600">SWAPS?</span>
                </h2>
                <p class="text-gray-600 text-lg leading-relaxed mb-6">
