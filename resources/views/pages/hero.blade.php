...
<div class="relative min-h-screen sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] overflow-hidden">
    ...
    <div class="hidden md:block relative min-h-screen sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
    ...
    <!-- Mobile Static Layout (No Carousel) -->
    <div class="block md:hidden">
        <!-- Mobile Slide 1 -->
        <div class="relative min-h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/background-image-1.webp') }}');">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/40"></div>
            <div class="relative z-10 flex items-center min-h-screen">
                <div class="max-w-7xl mx-auto px-5 py-16 w-full">
                    <div class="max-w-3xl mx-auto text-center">
                        <h1 class="text-4xl font-bold text-white mb-4 leading-tight">
                            Trade Shares and Forex with <span class="text-red-500">Financial Thinking</span>
                        </h1>
                        <p class="text-base text-gray-200 leading-relaxed mb-8">
                            Trade CFDs on a wide range of instruments, including popular FX pairs, Futures, Indices, 
                            Metals, Energies and Shares. Experience the global markets at your fingertips.
                        </p>
                        <a href="/register" class="inline-flex items-center justify-center px-6 py-3 text-base font-semibold rounded-full text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-500 shadow-lg">
                            Create Free Account
        ...
        <!-- Mobile Slide 2 -->
        <div class="relative min-h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/background-image-2.webp') }}');">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/40"></div>
            <div class="relative z-10 flex items-center min-h-screen">
                <div class="max-w-7xl mx-auto px-5 py-16 w-full">
                    <div class="max-w-3xl mx-auto text-center">
                        <h1 class="text-4xl font-bold text-white mb-4 leading-tight">
                            Competitive Edge for <span class="text-red-500">Institutions</span>
                        </h1>
                        <p class="text-base text-gray-200 leading-relaxed mb-8">
                            Institutions gain a competitive edge with PrimeVest's financial strength, advanced technology, 
                            and execution quality, empowering hedge funds, advisors, and broker-dealers to grow globally.
        ...
        <!-- Mobile Slide 3 -->
        <div class="relative min-h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/background-image-3.webp') }}');">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/40"></div>
            <div class="relative z-10 flex items-center min-h-screen">
                <div class="max-w-7xl mx-auto px-5 py-16 w-full">
                    <div class="max-w-3xl mx-auto text-center">
                        <h1 class="text-4xl font-bold text-white mb-4 leading-tight">
                            Trade Predictions on <span class="text-red-500">Events</span>
                        </h1>
                        <p class="text-base text-gray-200 leading-relaxed mb-8">
                            Use Forecast Contracts to trade your opinion on yes-or-no questions. 
                            Earn 3.14% APY on your investment with interest-like incentive coupons.
                        </p>
                        <a href="/forecast-trader" class="inline-flex items-center justify-center px-6 py-3 text-base font-semibold rounded-full text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-500 shadow-lg">
                            Learn More
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
        ...
        <!-- Mobile Slide 4 -->
        <div class="relative min-h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('{{ asset('images/background-image-4.jpg') }}');">
            <div class="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/40"></div>
            <div class="relative z-10 flex items-center min-h-screen">
                <div class="max-w-7xl mx-auto px-5 py-16 w-full">
                    <div class="max-w-3xl mx-auto text-center">
                        <h1 class="text-4xl font-bold text-white mb-4 leading-tight">
                            Trade US Stocks & <span class="text-red-500">Bonds 24/7</span>
                        </h1>
                        <p class="text-base text-gray-200 leading-relaxed mb-8">
                            React immediately to market-moving news and trade over 10,000 US Stocks and ETFs, 
                            US Equity Index futures and options, US Treasuries, and global bonds.
                        </p>
                        <a href="/trading" class="inline-flex items-center justify-center px-6 py-3 text-base font-semibold rounded-full text-white bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 transition-all duration-500 shadow-lg">
                            Start Trading
                            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                            </svg>
